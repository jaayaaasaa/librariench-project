    ...
    <div class="bg-white dark:bg-white shadow-lg rounded-sm border-gray-700 sm:max-w-sm md:max-w-xl lg:max-w-5xl mx-auto">
        ...
        <div class="p-6 space-y-6">
            <form wire:submit="create">
                <div class="grid grid-cols-6 gap-6 border-b-2 pb-6">
                    <div class="col-span-6 sm:col-span-3">
                        <label for="username" class="text-sm font-medium text-gray-900 block mb-2">Username</label>
                        <input wire:model="name" type="text" name="username" id="username" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Username" required="">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="col-span-full">
                        <label for="adress" class="text-sm font-medium text-gray-900 block mb-2">Adress</label>
                        <textarea wire:model="alamat" id="adress" rows="6" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" placeholder="Samarinda"></textarea>
                    </div>
                    <div class="col-span-full">
                        <label for="phone" class="text-sm font-medium text-gray-900 block mb-2">Phone</label>
                        <input wire:model="telpon" type="text" name="phone" id="phone" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="+628123456789" required="">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
